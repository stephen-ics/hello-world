            ...
            >
                <Resizable width={size.width} height={size.height} onResize={onResize}>
                    <div
                        ...
                        className={"bg-gray-50 text-black outline-solid outline-gray-300/50 w-full lg:min-w-[500px] min-w-[300px] lg:min-h-[30vh] min-h-[300px] border-2 border-solid border-gray-300 flex flex-col overflow-hidden" + (terminalFullscreen ? " rounded-none" : " rounded-lg")}
                    >
