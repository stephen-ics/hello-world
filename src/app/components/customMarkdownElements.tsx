...
const CustomH1 = ({ children }: { children: ReactNode }) => (
...
const CustomH4 = ({ children }: { children: ReactNode }) => (
    <h4 className="text-xl font-bold mb-2 mt-4 text-black">{children}</h4>
);

const CustomH5 = ({ children }: { children: ReactNode }) => (
    <h5 className="text-lg font-bold mb-2 mt-3 text-black">{children}</h5>
);

const CustomH6 = ({ children }: { children: ReactNode }) => (
...
const CustomEmphasis = ({ children }: { children: ReactNode }) => (
...
const CustomImage = ({ alt, src, title }: { alt?: string; src?: string; title?: string }) => (
    <div className="my-6">
      <img
...
const CustomCodeBlock = ({ language, value }: { language?: string; value?: string }) => (
